...
## InfoCanvas AI Model Support

InfoCanvas AI now supports multiple OpenAI image generation models:

### Supported Models

1. **DALL-E 3** (Stable)
   - Reliable and consistent image generation
   - Supports standard and HD quality
   - Natural and vivid style options
   - Sizes: 1024x1024, 1024x1792, 1792x1024

2. **GPT-Image-1** (Latest)
   - Superior instruction following
   - Enhanced text rendering capabilities
   - Real-world knowledge integration
   - Advanced features: transparency, high fidelity
   - Sizes: 1024x1024, 1024x1536, 1536x1024
   - Quality options: low, medium, high, auto
   - **Note**: Requires API Organization Verification

### Model Selection

Users can switch between models using the "AI Model" dropdown in the settings panel:
- 🎨 DALL-E 3 (Stable) - Recommended for consistent results
- ✨ GPT-Image-1 (Latest) - Recommended for advanced features and better text rendering
